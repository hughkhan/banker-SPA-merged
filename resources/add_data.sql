...
INSERT INTO field (entity_id, sys_field_type_id, name, config_data) VALUES ((SELECT id FROM entity WHERE name = 'Enterprise Bank'), (SELECT id FROM sys_field_type WHERE sys_data_type_id = (SELECT id FROM sys_data_type WHERE system_name = 'Security_Type')), 'Retirement_Account_Type', '[{ "value": 1, "label": "401(k)"}, { "value": 2, "label": " 403(b)"}, { "value": 3, "label": " IRA"}, { "value": 4, "label": " Deferred Compensation Plan"}, { "value": 5, "label": " Pension Plan"}]');
